        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b text-gray-500">
            <tr className="border-b">
              ...
              <th className="text-right px-2 pt-2 font-medium w-20" rowSpan={2}>参考価格<span className="block text-[10px] font-normal text-gray-400">上代</span></th>
              ...
              <th className="text-right px-1 pt-2 font-medium text-[11px] text-teal-700 w-12 border-l" rowSpan={2}>裁断費</th>
              <th className="text-right px-1 pt-2 font-medium text-[11px] text-purple-700 w-12" rowSpan={2}>生地費</th>
              <th className="text-right px-1 pt-2 font-medium text-[11px] text-amber-700 w-12" rowSpan={2}>資材費</th>
              <th className="text-right px-1 pt-2 font-medium text-[11px] text-pink-700 w-12" rowSpan={2}>梱包<br />資材費</th>
              <th className="text-right px-1 pt-2 font-medium text-[11px] text-emerald-700 w-12" rowSpan={2}>仕入</th>
          ...
          <tbody className="divide-y">
            {items.map((p, idx) => (
              ...
              >
                ...
                {/* 種別原価（表示のみ・生地/資材の内訳から自動計算） */}
                <td className="px-1 py-1.5 text-right text-gray-700 border-l tabular-nums">{p.breakdown ? p.breakdown.cuttingCost.toLocaleString() : "-"}</td>
